...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    s_runtime_chat.add_argument("--llm-config", type=str, default=None)
    ...
    s_runtime_eval.add_argument("--llm-config", type=str, default=None)
    ...
    s_voice_agent.add_argument("--llm-config", type=str, default=None)
    ...
    s_voice_smoke.add_argument("--llm-config", type=str, default=None)
